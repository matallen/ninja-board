							...
							<td colspan="2">
								<table class="card2" border=0>
									...
									<tr>
										...
										<td class="cardScore" rowspan="4"><img class="ninjaIcon _level"></img></td>
									...
									<tr>
										...
										<td class="cardScoreText" rowspan="3">gitlab</td>
